...
\end{itemize}
\end{algorithm}
\note{What are we doing about the sign of the determinants?  --- in the end we are making a denominator, so an object that probably makes the most sense as being defined up to sign; I would suggest having all this be up to an overall sign, but perhaps we can discuss in our next meeting.}
