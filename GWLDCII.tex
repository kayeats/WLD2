...
{\color{violet} This is a rephrasing of my theorem with Amat (Lemma 3.5 / Theorem 3.6): A set of vertices $V \subset [n]$ is independent if and only if it does not contain a $U \subsetneq V$ such that $|\Prop(U)| > |U|$, which is your injection condition. Is this second proof necessary? If so, should we at least cite that theorem?}
