...
Note that different $I_*$ impose different orderings on the propagators. Furthermore, Lemma \ref{lem no fourth vertex} shows that this ordering respects the ordering of vertices in $I_i$. That is, $I_i(p_j) <_i I_i(p_l)$ for all $j <l$.
