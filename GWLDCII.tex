...
We note that in this paper, we allow for the propagator set $\cP$ to be empty. This is for mathematical convenience, even though these diagrams are do not correspond to tree level scattering amplitudes.
