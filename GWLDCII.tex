...
\hlfix{Since SYM $N=4$ is a finite theory {\cite{Alday:2007hr, ParkeTaylorids}}, the scattering amplitudes (and thus the holomorphic Wilson loops $\,\mathfrak{W}_{k,n}$) are finite.}{Fix citations} That is, for a fixed set of external particles $\cZ$ we must have
