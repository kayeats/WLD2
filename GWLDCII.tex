...
\hlfix{}{I changed the last three paragraphs a certain amount more on account of referee M's comments 3 and 4 -- we should discuss it.} \sanote{should we make a comment about propagators being multisets here (in addition to changes below)? I remember parallel edges being bad being news to Lionel when I wrote the original paper.}
