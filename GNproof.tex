...
We claim that $Q_l \subseteq \cP_{m-1}$ for all $l\geq 0$. The base case follows immediately from the observation above that $\Prop(j_m) \subseteq \cP_{m-1}$.

[induction step; see final page]
